...
return false;
    ...
    bool push(const Empleado& e) {
        ...
        datos[++ult] = e; // insertamos al final
        return true;
    }
    ...
    if (Vacia()) {
        ...
        return false;  // No se pudo desapilar
    }
    ult--;  // Simplemente reducimos el índice del último elemento
    return true;  // Se desapiló correctamente
}
