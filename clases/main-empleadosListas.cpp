   ...
   do {
       ...
       switch(opcion){
           case 1: {
            ...
            Empleado nuevo(clave, nombre, domicilio, sueldo, reportaA);
           ...
           lista.buscar(codigoBuscar);
            ...
            case 3:{
            int pos;
            cout << "\nIngresa la posición del empleado a eliminar (0 a " << lista.getUlt() << "): ";
            cin >> pos;
            lista.eliminar(pos);
            lista.Mostrar();
            break;
            ...
            cin >> sueldo;
            cin.ignore();
            cout << "Dame a quién reporta: ";
            getline(cin, reportaA);

    int pos;
    cout << "Dame la posición donde se debe insertar el empleado: ";
    cin >> pos;
    Empleado e(clave, nombre, domicilio, sueldo, reportaA);
    lista.inserta(e, pos);
